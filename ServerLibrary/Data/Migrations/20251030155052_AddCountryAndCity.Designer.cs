...
namespace ServerLibrary.Data.Migrations
{
    ...
    [Migration("20251030155052_AddCountryAndCity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseLibrary.Entities.Doctor", b =>
                {
                    ...
                    b.Property<string>("MedicalReccomendation")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BaseLibrary.Entities.Sanction", b =>
                {
                    b.HasOne("BaseLibrary.Entities.Sanction", "SanctionType")
                        .WithMany()
            ...
            modelBuilder.Entity("BaseLibrary.Entities.SanctionType", b =>
                {
                    b.HasOne("BaseLibrary.Entities.Sanction", "Sanction")
                        .WithMany()
            ...
            modelBuilder.Entity("BaseLibrary.Entities.Vacation", b =>
                {
                    b.HasOne("BaseLibrary.Entities.VacationType", "VacationType")
                        .WithOne("Vacation")
                        .HasForeignKey("BaseLibrary.Entities.Vacation", "VacationTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
